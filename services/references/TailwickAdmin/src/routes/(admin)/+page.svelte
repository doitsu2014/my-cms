<script>
	...
	import OrderStatisticsChart from "./orderStatisticsChart.svelte";
	import Widget from "./Widget.svelte";
	import SalesRevenueOverview from "./SalesRevenueOverview.svelte";
	import TrafficResources from "./TrafficResources.svelte";
	import ProductOrders from "./ProductOrders.svelte";
	import CustomerService from "./CustomerService.svelte";
	import SalesOnThisMonth from "./SalesOnThisMonth.svelte";
	import TopSellingProducts from "./TopSellingProducts.svelte";
	import AudienceChart from "./AudienceChart.svelte";
</script>

<HeadTitle title="Ecommerce" />
<CounterPage />
        ...
        <div class="col-span-12 card 2xl:col-span-4 2xl:row-span-2">
            <div class="card-body">
                <div class="flex items-center mb-3">
                    ...
                    <div class="relative">
                        <a href="#!" class="underline transition-all duration-200 ease-linear text-custom-500 hover:text-custom-600">View All <LucideIcon name="MoveRightIcon"  class="inline-block size-4 align-middle ltr:ml-1 rtl:mr-1"/></a>
                    </div>
                </div>
                <OrderStatisticsChart chartColors={["bg-purple-500", "bg-sky-500"]}/>
            </div>
        </div>
        <Widget />
