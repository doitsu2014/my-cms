<script>
	...
	import { ExpensesData } from '../../../../../common/data/hrmanagement';
				...
				<div class="xl:col-span-2 xl:col-start-11">
					<div class="lg:ltr:text-right lg:rtl:text-left">
						<a
							...
							<span class="align-middle">Add Expense</span></a
						>
					</div>
				</div>
			</div>
			...
			<div class="-mx-5 overflow-x-auto">
				<table class="w-full whitespace-nowrap">
					...
					>
						<tr>
							<th
								class="px-3.5 py-2.5 first:pl-5 last:pr-5 font-semibold border-b dark:border-zink-500"
								>Purchase Date</th
							>
							<th
								class="px-3.5 py-2.5 first:pl-5 last:pr-5 font-semibold border-b dark:border-zink-500"
							...
							<tr>
								...
								>
									<Dropdown className="relative">
										...
										<DropdownMenu
											class="absolute z-50 py-2 mt-1 ltr:text-left rtl:text-right list-none bg-white rounded-md shadow-md min-w-[10rem] dark:bg-zink-600"
										>
											<li>
												<a
			...
			<form action="#!">
				<div class="grid grid-cols-1 gap-4 xl:grid-cols-12">
					<div class="xl:col-span-12">
						<label for="PurchaseInput" class="inline-block mb-2 text-base font-medium"
							>Purchase Date</label
						>
						<Flatpickr
							type="text"
					...
					<div class="xl:col-span-12">
						<label for="purchasedByInput" class="inline-block mb-2 text-base font-medium"
							>Purchased By</label
						>
						<input
							type="text"
