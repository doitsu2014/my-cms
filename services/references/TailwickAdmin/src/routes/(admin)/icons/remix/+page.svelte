...
<HeadTitle title="Remix Icons" />

<div class="container-fluid group-data-[content=boxed]:max-w-boxed mx-auto">
	<Breadcrumb title="Remix Icons" pagetitle="Icons" />
		...
		<div class="card">
			<div class="card-body">
				...
				<div class="text-center">
					<a href="https://remixicon.com/" target="_blank" class="text-white transition-all duration-200 ease-linear btn bg-custom-500 border-custom-500 hover:text-white hover:bg-custom-600 hover:border-custom-600 focus:text-white focus:bg-custom-600 focus:border-custom-600 focus:ring focus:ring-custom-100 active:text-white active:bg-custom-600 active:border-custom-600 active:ring active:ring-custom-100">Remix Icons Library</a>
				</div>
			</div>
		</div>
</div>
