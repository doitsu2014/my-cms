<script>
	...
	import DailyVisitInsightsChart from './DailyVisitInsightsChart.svelte';
</script>
...
<div class="order-10 col-span-12 2xl:order-1 card 2xl:col-span-4">
	<div class="card-body">
		<div class="flex items-center gap-2 mb-3">
			<h6 class="text-15 grow">
				Daily Visit Insights <a
					...
					class="inline-block align-middle ltr:ml-1 rtl:mr-1 text-slate-500 dark:text-zink-200"
					><LucideIcon name="info" class="size-4" /></a
				>
			</h6>
		...
		<DailyVisitInsightsChart chartColors={['bg-green-500', 'bg-purple-500']} />
	</div>
</div>
