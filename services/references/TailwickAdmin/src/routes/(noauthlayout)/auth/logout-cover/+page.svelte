...
<svelte:body use:classList={'flex items-center justify-center min-h-screen py-16 bg-cover bg-auth-pattern dark:bg-auth-pattern-dark dark:text-zink-100 font-public'} />

<HeadTitle title="Log Out" />
    ...
    <div class="!px-10 !py-12 card-body">
        ...
        <div class="mt-8 text-center">
            <div class="mb-4 text-center">
                <LucideIcon name="LogOut" class="size-6 mx-auto text-purple-500 fill-purple-100"/>
            </div>
        ...
        <a href="/auth/signin-basic" class="w-full text-white transition-all duration-200 ease-linear btn bg-custom-500 border-custom-500 hover:text-white hover:bg-custom-600 hover:border-custom-600 focus:text-white focus:bg-custom-600 focus:border-custom-600 focus:ring focus:ring-custom-100 active:text-white active:bg-custom-600 active:border-custom-600 active:ring active:ring-custom-100 dark:ring-custom-400/20">Sign In</a>
    </div>
</div>