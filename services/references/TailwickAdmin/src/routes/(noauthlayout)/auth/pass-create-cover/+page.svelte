...
<HeadTitle title="Create password" />
    ...
    <div class="!px-10 !py-12 card-body">
        ...
        <form autocomplete="off" action="/">
            ...
            <div class="mt-4 text-center">
                <p class="mb-0">Hold on, I've got my password... <a href="/auth/signin-basic" class="underline fw-medium text-custom-500"> Click here </a> </p>
            </div>
        </form>
    </div>
</div>