    ...
    Array.from(datas).forEach(function (mailData, index) {
        ...
        <td class="px-3.5 py-2.5 border-y border-transparent first:pl-0 last:pr-0 w-20">
            <div class="flex items-center gap-3 ltr:pl-2 rtl:pr-2">
                ...
                <a href="#!" class="transition-all duration-200 ease-linear text-slate-500 hover:text-yellow-500 dark:text-zink-200 dark:hover:text-yellow-500 `+ checkStarred + `"><LucideIcon name="star" class="w-4 h-4"></i></a>
                <a href="#!" class="transition-all duration-200 ease-linear text-slate-500 hover:text-yellow-500 dark:text-zink-200 dark:hover:text-yellow-500"><LucideIcon name="step-forward" class="w-4 h-4"></i></a>
            </div>
        </td>
