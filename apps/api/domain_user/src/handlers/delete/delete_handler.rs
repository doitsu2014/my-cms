//! `DeleteUserHandler` — application-layer command handler that deletes
//! a CMS user through the Supabase GoTrue admin API. Self-delete is
//! blocked at the application boundary.
...
use crate::{domain::error::AppError, handlers::supabase_admin_client::SupabaseAdminClient};
