//! `ReadOneUserHandler` — application-layer command handler that fetches
//! a single CMS user via the Supabase GoTrue admin API.
...
use crate::{
    domain::error::AppError, dto::AppUserModel,
