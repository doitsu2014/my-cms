//! `ModifyUserHandler` — application-layer command handler that updates
//! an existing CMS user through the Supabase GoTrue admin API.
...
use crate::{
    ...
    handlers::{
        modify::modify_request::ModifyUserRequest, supabase_admin_client::SupabaseAdminClient,
    },
};
