//! ModelsHandler — returns the curated OpenAI model catalogue.
//!
//! Moved from `application_core::commands::ai::models::models_handler` per
//! Decision 2 of the `consolidate-category-ai-translate-into-domain-posts`
//! change.
...
impl ModelsHandler {
    ...
    fn get_hardcoded_models() -> Vec<OpenAIModelInfo> {
        vec![
            // GPT-4o-mini - best balance (DEFAULT & RECOMMENDED)
            OpenAIModelInfo::new(
                "gpt-4o-mini".to_string(),
                "GPT-4o Mini (Default)".to_string(),
                0.15,
                0.60,
                128000,
                16384,
            ...
            .with_recommendation(
                "Default model. Best balance of cost and quality for translations. Reliable and fast.".to_string()
            ),
