use crate::{
    domain::{error::AppError, extensions::StringExtension},
    handlers::{is_image_content_type, MediaConfig, MediaModel},
};
use nanoid::nanoid;
use std::sync::Arc;
use tracing::info;
...
mod tests {
    use super::*;
    use crate::handlers::supabase_storage::SupabaseStorage;
    use wiremock::{
